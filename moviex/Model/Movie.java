...
public class Movie {
    ...
    // By specifying @SerializedName, GSON will not look in json
    // based on variable name & will just use specified name
    // Especially if code is obscured.
    ...
    public Movie (String posterPath, boolean adult, String overview, String releaseDate, List genreIds,
