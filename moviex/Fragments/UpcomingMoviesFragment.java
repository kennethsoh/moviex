...
public class UpcomingMoviesFragment extends Fragment {
    ...
    private void loadJSON(){
        try {
            ...
            // API service: getUpcomingMovies ; change to other forms to get other types
            Call<MovieResponse> call = apiService.getUpcomingMovies(BuildConfig.THE_MOVIE_DB_API_TOKEN);
